...
class BaseZone(models.Model):
    ...
    default_user_id = fields.Many2one(
        ...
        index=False,
        default=None,
        help='Choose which user will be the default for this zone',
        comodel_name='res.users',
        domain=[],
        context={},
        ondelete='cascade',
    ...
    subordinate_zip_ids = fields.Many2many(
        ...
        index=False,
        default=None,
        help='Zip codes of all subordinate zones including this same',
        comodel_name='res.better.zip',
    ...
    holder_user_ids = fields.Many2many(
        ...
        index=False,
        default=None,
        help='Users of all holder zones including this same',
        comodel_name='res.users',
    ...
    subordinate_user_ids = fields.Many2many(
        ...
        index=False,
        default=None,
        help='Users of all subordinate zones including this same',
        comodel_name='res.users',
